...
setwd("/Users/home/Dropbox/Amherst/Post-Doc/Muscles/OJ_PJ/Writing/MS/Writing/ReSubmission/FinalSubmission/GitHub/QTL/FineMap/LOJ/PC1/")
...
#write.csv(CombinedDataEffectEo,"LG7FineMapDataT_LOJpc1_Stringent_noaug.csv", quote = F, row.names = F)


##Plot
#setwd("/Users/home/Dropbox/Amherst/Post-Doc/Muscles/OJ_PJ/QTL/New/LOJ/FineMap/PC1/NewLG/")
#CombinedDataEffectEo<-read.csv("LG7FineMapDataT_LOJpc1_Stringent_noaug.csv")

...
setwd("/Users/home/Dropbox/Amherst/Post-Doc/Muscles/OJ_PJ/Writing/MS/Writing/ReSubmission/FinalSubmission/GitHub/QTL/FineMap/LOJ/PC2/")
...
#write.csv(CombinedDataEffectEo,"LG7FineMapDataT_LOJpc2_Stringent_noaug.csv", quote = F, row.names = F)


##Plot
#setwd("/Users/home/Dropbox/Amherst/Post-Doc/Muscles/OJ_PJ/QTL/New/LOJ/FineMap/PC2/NewLG/")
#CombinedDataEffectEo<-read.csv("LG7FineMapDataT_LOJpc2_Stringent_noaug.csv")

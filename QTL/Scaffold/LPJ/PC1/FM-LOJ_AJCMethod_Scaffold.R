...
setwd("/Users/home/Dropbox/Amherst/Post-Doc/Muscles/OJ_PJ/Writing/MS/Writing/ReSubmission/FinalSubmission/GitHub/QTL/Scaffold/LPJ/PC1/")
...
#write.csv(CombinedDataEffectEo,"Scaffold0FineMapDataT_LPJpc1_Stringent_noaug.csv", quote = F, row.names = F)


##Plot
#setwd("/Users/home/Dropbox/Amherst/Post-Doc/Muscles/OJ_PJ/QTL/New/LPJ/FineMap/PC1/Scaffold0/")
#CombinedDataEffectEo<-read.csv("Scaffold0FineMapDataT_LPJpc1_Stringent_noaug.csv")
...
#write.csv(CombinedDataEffectEo,"Scaffold21FineMapDataT_LPJpc1_Stringent_noaug.csv", quote = F, row.names = F)


##Plot
#setwd("/Users/home/Dropbox/Amherst/Post-Doc/Muscles/OJ_PJ/QTL/New/LPJ/FineMap/PC1/Scaffold/")
#CombinedDataEffectEo<-read.csv("Scaffold21FineMapDataT_LPJpc1_Stringent_noaug.csv")
...
plot(MapPPP$Pos, abs(MapPPP$AA.BB), ylim = range(abs(MapPPP$AA.BB)), type='l', lwd=2, axes=T, xlab=NA, ylab=NA, col="blue")
abline(h=0)

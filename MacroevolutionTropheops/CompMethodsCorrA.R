...
LPJ_CichlidMeanShapes<-readland.tps(file = "NaturalPopulation_LPJ_MeanData_20210826.tps", specID = "ID")
LOJ_CichlidMeanShapes<-readland.tps(file = "NaturalPopulation_LOJ_MeanData_20210826.tps", specID = "ID")
